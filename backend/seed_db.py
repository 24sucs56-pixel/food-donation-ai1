...
def seed():
    ...
    users_list = [
        # === PRE-APPROVED DEMO ACCOUNTS ===
        {
            ...
            "password": bcrypt.hashpw("Donor@12345".encode("utf-8"), bcrypt.gensalt()),
            "role": "donor",
        ...
        },
        {
            ...
            "password": bcrypt.hashpw("Ngo@12345".encode("utf-8"), bcrypt.gensalt()),
            "role": "ngo",
        ...
        },
        {
            ...
            "password": bcrypt.hashpw("Volunteer@12345".encode("utf-8"), bcrypt.gensalt()),
            "role": "volunteer",
            "vehicle": "Two Wheeler",
            "phone": "9999999903",
            "state": "Tamil Nadu",
        ...
        },
        {
            ...
            "password": bcrypt.hashpw("Admin@12345".encode("utf-8"), bcrypt.gensalt()),
            "role": "admin",
            "phone": "9999999904",
            "state": "Tamil Nadu",
            "district": "Madurai",
